...
namespace InSimDotNet.Packets {
    ...
    public class CarContact {
        public byte Throttle => (byte)((ThrBrk >> 4) & 0xF);
        public byte Brake => (byte)(ThrBrk & 0xF);
        public byte Clutch => (byte)((CluHan >> 4) & 0xF);
        public byte Handbrake => (byte)(CluHan & 0xF);
        public byte Gear => (byte)((GearSp >> 4) & 0xF);
